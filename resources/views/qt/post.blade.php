                    ...
                    <div class="row f-c">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="box box-success box-shadow-1">
                                ...
                                <div class="box-body pd-tb-0">
                                    <div class="progress xs mr-b-0">
                                        <div class="progress-bar progress-bar-green eTMP"
                                             style="width: {{$aTRPercent}}%;"></div>
                                    </div>
                                </div>
                                <div class="box-footer pd-tb-0">
                    ...
                    <div class="tab-content">
                            ...
                            <form action="vacation/post" method="post">
                                ...
                                <div class="flex-pcenter">
                                    <div class="f-w-o1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="LESDate"
                                                           class="form-control i-o1 f0 hasSetDate" autocomplete="off"
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" style="text-align: center"
                                                           class="form-control f0" placeholder="How long..."
                                                           id="minutePicker" name="time" required autocomplete="off">
                                                    <div class="input-group-btn">
                                        ...
                                        <div class="row mgt15">
                                            <div class="col-xs-6">
                                                <a class="btn btn-default btn-block" href="{{route('vacation.list')}}">Back</a>
                                            </div>
                                            <div class="col-xs-6">
                        ...
                        <div id="menu1" class="tab-pane fade">
                            <form action="qt/post" method="post">
                                @csrf
                                <input type="text" name="type" value="{{Constants::OUT_VACATION}}"
                                       style="display: none">
                                    ...
                                    <div class="f-w-o1">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <span class="input-group-addon bg-primary"><i
                                                                class="fa fa-calendar"></i></span>
                                                    <input type="text" id="OSDate"
                                                           class="form-control hasSetDate i-o1 f1" autocomplete="off"
                                                           required name="startDate">
                                                </div>
                                            </div>
                                            <div class="col-md-6 rmgt-o1">
                                                <div class="input-group">
                                                    <input type="text" id="oVST"
                                                           class="form-control startTimepicker i-o1 f1"
                                                           placeholder="start" name="startTime" required
                                                           autocomplete="off">
                                                    <span class="input-group-addon bg-primary"><i
                                                                class="fa fa-arrow-right"></i></span>
                                                    <input type="text" id="oVET"
                                                           class="form-control endTimepicker i-o1 f1" placeholder="end"
                                                           name="endTime" required autocomplete="off">
                                                </div>
                                                <span id="spent"></span>
                                            </div>
                                        </div>
                                        <div class="row c-comment1">
                                            <div class="col-md-12 mgt15">
                                                <textarea rows="1" name="comment" placeholder="Your comment..."
                                                          class="form-control f1 comment" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="row mgt15">
                                            <div class="col-xs-6">
                                            ...
                                            <div class="col-xs-6">
                                                <button class="btn btn-success btn-block" type="submit" id="sBtnf0">
                                                    Submit
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div id="menu2" class="tab-pane fade">
                            <form action="{{ route('vacation.post') }}" method="post">
                                @csrf
                                <div class="flex-pcenter">
                                    <div class="f-w-o1">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <input type="text" id="vSDate" class="form-control i-o1 f2 noSetDate"
                                                       placeholder="Start date" name="startDate" autocomplete="off"
                                                       required>
                                            </div>
                                            <div class="col-xs-6">
                                                <input type="text" id="vEDate" class="form-control i-o1 f2 noSetDate"
                                        ...
                                        <div class="row mgt15">
                                            <div class="col-xs-6">
                                                <div class="dropdown">
                                                    <input class="dropdown-toggle form-control i-o1 f2" id="vSTime"
                                                           data-toggle="dropdown" placeholder="Start time"
                                                           autocomplete="off" name="startTime" required>
                                                    <ul class="dropdown-menu dropdown-menu-o1">
                                                        @foreach($shifts as $s)
                                                            <li class="mr-b-5">
                                                                <a title="{{ substr($s->start,0,5) }}"
                                                                   style="cursor:default" class="pd-lr-20 optionSTime">Start
                                                                    of {{$s->name}}</a>
                                                            </li>
                                                        @endforeach
                                                        <li class="virusInput">
                                                            <input type="text"
                                                                   class="form-control cStartTime  mr-b-8 f2"
                                                                   placeholder="Your custom time" autocomplete="off"
                                                                   name="cStartTime">
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="col-xs-6">
                                                <div class="dropdown">
                                                    <input class="dropdown-toggle form-control i-o1 f2" id="vETime"
                                                           data-toggle="dropdown" placeholder="End time"
                                                           autocomplete="off" name="endTime" required>
                                                    <ul class="dropdown-menu dropdown-menu-o1">
                                                        @foreach($shifts as $s)
                                                            <li class="mr-b-5">
                                                                <a title="{{ substr($s->end,0,5) }}"
                                                                   style="cursor:default" class="pd-lr-20 optionETime">End
                                                                    of {{$s->name}}</a>
                                                            </li>
                                                        @endforeach
                                                        <li class="virusInput">
                                                            <input type="text" class="form-control cEndTime mr-b-8 f2"
                                                                   placeholder="Your custom time" autocomplete="off"
                                                                   name="cEndTime">
                                                        </li>
                                                    </ul>
                                            ...
                                            <div class="col-md-12 mgt15">
                                                <div class="dropdown">
                                                    <select name="type" id="rSelect2" class="form-control" required>
                                                        <option value="" disabled selected style="display: none">Your
                                                            reason...
                                                        </option>
                                        ...
                                        <div class="row c-comment2" style="display: none">
                                            <div class="col-md-12 mgt15">
                                                <textarea rows="1" name="comment" placeholder="Your comment..."
                                                          class="form-control f2 comment" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="row mgt15">
                                            <div class="col-xs-6">
                                            ...
                                            <div class="col-xs-6">
                                                <button class="btn btn-success btn-block" type="submit" id="btnfv">
                                                    Submit
                                                </button>
                                            </div>
                                        </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //minute picker
            {
                var step = <?php echo $setting->hour_step?>*
                60;
                var maxTime = <?php echo $setting->short_leave ?>*
                60;
                var value = 0;
