            ...
            <div class="box-body no-padding">
                <table class="table table-hover">
                    ...
                    <tr id="ot-item{{$i->id}}">
                        ...
                        <td>{{$i->name}}</td>
                        <td><a href="#" onclick="event.preventDefault()" id="e-ot{{$i->id}}" style="{{$display}}"><i
                                        class="fa fa-edit"></i></a></td>
                        <td><a href="#" onclick="event.preventDefault()" id="r-ot{{$i->id}}" style="{{$display}}"><i
                                        class="fa fa-remove" style="color:red"></i></a></td>
                    </tr>
                    @else
                    <tr>
                        <td>Empty</td>
