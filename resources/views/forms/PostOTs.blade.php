...
<div class="alert alert-danger displayWarning">
    <h4>- Date must be greater or equal today</h4>
    <h4>- End must by greater than start</h4>
</div>
<div class="alert alert-danger displayExistOT">
    <h4>- Your ot time is conflict</h4>
</div>
